...
*Note: For details on the firmware (PIC18F4620 and Pi Pico) and the automated laptop testing scripts, please refer to the separate software documentation: [Zx50BusProbeSw.md](../../Zx50_BusProbe_Firmware/Zx50BusProbeSw.md).*
